...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SentryInstance.sentry_instance_name'
        db.alter_column(u'website_sentryinstance', 'sentry_instance_name', self.gf('django.db.models.fields.CharField')(default='sentry01', unique=True, max_length=128))
        # Adding unique constraint on 'SentryInstance', fields ['sentry_instance_name']
        db.create_unique(u'website_sentryinstance', ['sentry_instance_name'])


        # Changing field 'SentryInstance.sentry_instance_url_prefix'
        db.alter_column(u'website_sentryinstance', 'sentry_instance_url_prefix', self.gf('django.db.models.fields.CharField')(default='sentry02', max_length=250))

    def backwards(self, orm):
        # Removing unique constraint on 'SentryInstance', fields ['sentry_instance_name']
        db.delete_unique(u'website_sentryinstance', ['sentry_instance_name'])


        # Changing field 'SentryInstance.sentry_instance_name'
        db.alter_column(u'website_sentryinstance', 'sentry_instance_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'SentryInstance.sentry_instance_url_prefix'
        db.alter_column(u'website_sentryinstance', 'sentry_instance_url_prefix', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
