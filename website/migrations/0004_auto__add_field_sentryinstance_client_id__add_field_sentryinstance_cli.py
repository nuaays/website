...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SentryInstance.client_id'
        db.add_column(u'website_sentryinstance', 'client_id',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True),
                      keep_default=False)

        # Adding field 'SentryInstance.client_secret'
        db.add_column(u'website_sentryinstance', 'client_secret',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SentryInstance.client_id'
        db.delete_column(u'website_sentryinstance', 'client_id')

        # Deleting field 'SentryInstance.client_secret'
        db.delete_column(u'website_sentryinstance', 'client_secret')
